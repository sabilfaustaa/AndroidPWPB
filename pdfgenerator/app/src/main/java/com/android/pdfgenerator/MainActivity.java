package com.android.pdfgenerator;
...
public class MainActivity extends AppCompatActivity {
        ...
        mCreateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mContentEditText.getText().toString().isEmpty()){
                    mContentEditText.setError("Input Text Can't NULL!");
    ...
    private void createPdf() throws FileNotFoundException, DocumentException {
        ...
        if (!docsFolder.exists()) {
            docsFolder.mkdir();
            Log.i(TAG, "Create new folder PDF");
        }
    ...
    private void previewPdf() {
        ...
        if (list.size() > 0) {
            ...
            Toast.makeText(this,"Download application pdf viewer see the result",Toast.LENGTH_SHORT).show();
        }
    }
}