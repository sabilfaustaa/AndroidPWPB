...
public class AtasActivity extends AppCompatActivity implements View.OnClickListener {
    Button atas, bawah, kiri, kanan;
    String direksi_awal = "Atas";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.atas);
